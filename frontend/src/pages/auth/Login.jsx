  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 flex items-center justify-center px-6 py-12">
      ...
      <div className="relative w-full max-w-md">
        {/* Back Button */}
        <button
          className="absolute -top-16 left-0 flex items-center space-x-2 text-gray-600 hover:text-orange-600 transition-colors"
          onClick={() => {
        ...
        <div className="bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-gray-900 to-black p-8 text-center">
            ...
            <p className="text-gray-300">Sign in to your MunchMate account</p>
          </div>
